...
void render::initialize() {
	...
	interfaces::surface->set_font_glyph(render::fonts::watermark_font, "Tahoma ", 12, 500, 0, 0,font_flags::fontflag_antialias | font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::menu_font, "verdana ", 12, 500, 0, 0,font_flags::fontflag_antialias);
