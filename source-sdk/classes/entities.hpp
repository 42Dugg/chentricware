...
public:
	...
	NETVAR("DT_PlantedC4", "m_flC4Blow", m_flC4Blow,float_t);
	NETVAR("DT_PlantedC4", "m_flDefuseCountDown", m_flDefuseCountDown, float_t);
	NETVAR("DT_PlantedC4", "m_bBombDefused", m_bBombDefused,bool);
	NETVAR("DT_PlantedC4", "m_hBombDefuser", m_hBombDefuser, int);
	NETVAR("DT_PlantedC4", "m_flTimerLength", m_flTimerLength, float_t);
...
public:
	...
	NETVAR("DT_CSPlayer", "m_bWaitForNoAttack", waitForNoAttack, bool)
